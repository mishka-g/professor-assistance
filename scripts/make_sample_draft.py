"""Generate a synthetic (deliberately rough) student draft .docx for testing / demos.

Run: `python scripts/make_sample_draft.py`

Writes:
  - `data/drafts/sample_draft.docx` (CLI quick test)
  - `example_paperworks/student_paper/student_draft.docx` (golden-path demo pack)
"""
...
OUTS = [
    ROOT / "data" / "drafts" / "sample_draft.docx",
    ROOT / "example_paperworks" / "student_paper" / "student_draft.docx",
]
